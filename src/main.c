...
/**
 * @breif Update ml_online widget. First clear all the text,
 *        then append online information one by one.
 */
...
/**
 * @brief Called when other client send MSG_TYPE_EXIT message,
